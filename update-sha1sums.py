...
proprietaryFiles = 'proprietary-files.txt'
targetDevice = 'm1882'
...
lines = [line for line in open(proprietaryFiles, 'r')]
vendorPath = '../../../vendor/meizu/' + targetDevice + '/proprietary'
...
with open(proprietaryFiles, 'w') as file:
    for line in lines:
        file.write(line)
